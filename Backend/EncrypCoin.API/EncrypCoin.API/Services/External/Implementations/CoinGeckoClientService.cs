...
{
    public class CoinGeckoClientService : BaseHttpService, ICoinGeckoClient
    {
        private readonly ICacheService _cache;
        private readonly ILogger _logger;

        public CoinGeckoClientService(HttpClient client, ILogger<CoinGeckoClientService> logger, ICacheService cache) : base(client, logger)
        { 
            _cache = cache;
            _logger = logger;
        }
